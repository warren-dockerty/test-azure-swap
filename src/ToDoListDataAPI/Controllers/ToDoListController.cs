...
namespace ToDoListDataAPI.Controllers
{
    public class ToDoListController : ApiController
    {
        ...
        static ToDoListController()
        {
            ...
            mockData.Add(2, new ToDoItem { ID = 2, Owner = "*", Description = ConfigurationManager.AppSettings["ConfigKey"] });
            mockData.Add(3, new ToDoItem { ID = 3, Owner = "*", Description = ConfigurationManager.AppSettings["SwapKey"] });
            mockData.Add(4, new ToDoItem { ID = 4, Owner = "*", Description = ConfigurationManager.ConnectionStrings["TestConnection"].ConnectionString });
        }
